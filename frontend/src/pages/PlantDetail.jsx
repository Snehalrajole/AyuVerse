...
const PlantDetail = () => {
  ...
  const plantsData = {
    "holy-basil": {
      ...
      ayushApplication: {
        ayurveda:
          "Used for respiratory conditions, stress relief, and immune system support.",
        unani: "Used for treating cough, cold, and as a digestive aid.",
        siddha:
          "Used for skin conditions, respiratory ailments, and enhancing mental clarity.",
      },
      healthBenefits: [
    ...
    aloe: {
      ...
      ayushApplication: {
        ...
        siddha:
          "Used for treating constipation, skin ailments, and enhancing digestion.",
      },
      healthBenefits: [
    ...
    neem: {
      ...
      ayushApplication: {
        ayurveda:
          "Used for skin diseases, dental care, and blood purification.",
        unani: "Used for treating infections, fever, and as a purgative.",
        siddha:
          "Used for skin disorders, diabetes management, and immune support.",
      },
      healthBenefits: [
    ...
    garlic: {
      ...
      ayushApplication: {
        ayurveda:
          "Used for cardiovascular health, respiratory conditions, and digestive disorders.",
        unani:
          "Used for treating infections, hypertension, and as a carminative.",
        siddha:
          "Used for heart health, cholesterol management, and immune enhancement.",
      },
      healthBenefits: [
    ...
    turmeric: {
      ...
      ayushApplication: {
        ayurveda:
          "Used for inflammation, digestive disorders, and skin conditions.",
        unani:
          "Used for wound healing, liver health, and as an anti-inflammatory agent.",
        siddha:
          "Used for arthritis, digestive issues, and enhancing skin complexion.",
      },
      healthBenefits: [
  ...
  const plantNarration = useMemo(() => {
    ...
    const partsUsed =
      plant.partUsed && plant.partUsed.length
        ? `Traditional healers often use the ${plant.partUsed.join(", ")}.`
        : "";
    const properties =
      plant.therapeuticProperties && plant.therapeuticProperties.length
        ? `It is known for ${plant.therapeuticProperties
            .slice(0, 3)
            .join(", ")
            .toLowerCase()} properties.`
        : "";
    const benefits =
      plant.healthBenefits && plant.healthBenefits.length
        ? `Some key benefits include ${plant.healthBenefits
            .slice(0, 2)
            .join(", ")}.`
        : "";
    const dosage =
      plant.dosageForms && plant.dosageForms.length
        ? `Common preparations are ${plant.dosageForms
            .slice(0, 2)
            .join(" and ")}.`
        : "";
      ...
      <div className="plant-detail-content">
              ...
              <>
                <div className="viewer-controls">
                  <button
                    ...
                    aria-label={
                      isSpeaking
                        ? `Stop narration for ${plant.name}`
                        : `Play narration for ${plant.name}`
                    }
                  >
                    <svg
                      width="20"
        ...
        <div className="medicinal-info-column">
          ...
          >
            ...
            <div className="info-card-text">
              <strong>Part used in medicinal:</strong>{" "}
              {plant.partUsed.join(", ")}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="info-card-text">
              <strong>Active compounds in plants:</strong>{" "}
          ...
          >
            ...
            <div className="info-card-text">
              <strong>Therapeutic properties in plants:</strong>{" "}
              {plant.therapeuticProperties.join(", ")}
            </div>
          </motion.div>
